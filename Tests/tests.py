from benchmarking_methods import load_regression_datasets,load_classification_datasets,run_cross_dataset_benchmark,run_cross_dataset_benchmark_models
import pytest
import regression_datasets_loaders
import classification_datasets_loaders
import numpy as np
